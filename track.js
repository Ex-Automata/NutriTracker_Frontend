...
function saveLog(element, log) {
    ...
    fetchWithAuth('https://api.nutritracker.exautomata.ai/logs', {
        method: 'POST',
...
window.sendToAIChat = function(userMsg) {
    ...
    return fetchWithAuth('https://api.nutritracker.exautomata.ai/ai_chat', {
        method: 'POST',
        headers: {
...
function fetchLogs() {
    fetchWithAuth('https://api.nutritracker.exautomata.ai/logs?limit=20', {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' }
    })
    .then(res => res.json())
